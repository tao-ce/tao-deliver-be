...
class DeliveryPublicationFailedMessageTest extends TestCase
{
    private DeliveryPublicationFailedMessage $message;

    protected function setUp(): void
    {
        $this->message = new DeliveryPublicationFailedMessage(
            null,
            'tenantId',
            [
                'locale' => 'en-US',
    ...
    {
        $this->assertNull($this->message->getDeliveryId());
    }
