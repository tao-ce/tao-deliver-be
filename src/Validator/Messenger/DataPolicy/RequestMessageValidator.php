...
class RequestMessageValidator
{
    ...
    public function validateAndNormalize(array $raw): array
    {
        ...
        try {
            $body = json_decode($raw['body'], true, flags: JSON_THROW_ON_ERROR);
        } catch (JsonException $e) {
            throw new RequestValidationException(sprintf('Invalid JSON message body. Error: %s', $e->getMessage()));
        }
