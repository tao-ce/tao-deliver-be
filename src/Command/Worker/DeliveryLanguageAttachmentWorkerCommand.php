 ...
 */
#[AsCommand(
    name: 'worker:delivery-language-attachment',
)]
class DeliveryLanguageAttachmentWorkerCommand extends Command
{
    use StreamReader;

    private const NAME = 'worker:delivery-language-attachment';

    public function __construct(
        private DeliveryLanguageAttachmentHandler $handler,
    ...
    {
        $this->setDescription('Worker to execute delivery language attachment logic.');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if (!$message instanceof DeliveryLanguageAttachmentMessage) {
