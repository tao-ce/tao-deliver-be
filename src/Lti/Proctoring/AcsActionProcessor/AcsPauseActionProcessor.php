...
class AcsPauseActionProcessor implements AcsActionProcessorInterface
{
    ...
    {
        return $acsControl->getAction() === AcsControlInterface::ACTION_PAUSE;
    }
    ...
    public function process(
        ...
        $deliveryExecution->setStatus(DeliveryExecution::STATUS_SUSPENDED);
