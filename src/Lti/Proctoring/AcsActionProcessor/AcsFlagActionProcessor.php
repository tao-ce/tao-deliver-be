...
class AcsFlagActionProcessor implements AcsActionProcessorInterface
{
    ...
    {
        return $acsControl->getAction() === AcsControlInterface::ACTION_FLAG;
    }
    ...
    public function process(
        ...
        $deliveryExecution->setIsFlagged(true);
